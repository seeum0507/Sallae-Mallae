...
export function AllReviewsPage() {
  ...
  // Duplicate reviews to simulate a larger list
  const allReviews = [
    ...product.reviews,
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24">
      <div className="mb-8 border-b border-gray-100 pb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <select className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-mint-500/20 focus:border-mint-500 cursor-pointer">
            <option>도움순</option>
            <option>최신순</option>
